		...
		<form action="" method="POST"> 
                                <div class="form-group"> 
                                    ...
                                    <div class="input-group pb-modalreglog-input-group"> 
                                        <input type="number" class="form-control" id="amount" name="amount" placeholder="Amount in Rupees"> 
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="input-group pb-modalreglog-input-group"> 
                                        <input type="number" class="form-control" id="period" name="period" placeholder="Period Days"> 
